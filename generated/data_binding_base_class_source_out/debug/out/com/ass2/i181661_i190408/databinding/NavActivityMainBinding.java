...
public final class NavActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final Screen2Binding appBarDrawer;
  ...
  private NavActivityMainBinding(@NonNull DrawerLayout rootView,
      @NonNull Screen2Binding appBarDrawer, @NonNull DrawerLayout drawerLayout,
  ...
  public static NavActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      Screen2Binding binding_appBarDrawer = Screen2Binding.bind(appBarDrawer);
